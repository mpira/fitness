...
/**
 * EmploieId generated by hbm2java
 */
@Embeddable
public class EmploieId implements java.io.Serializable {
	...
	public EmploieId(int idLicence, int idPersonne) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EmploieId))
			return false;
		EmploieId castOther = (EmploieId) other;
